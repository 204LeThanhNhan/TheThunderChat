...
const AddFriendModal = () => {
    ...
    const [searchedUsername, setSearchedUsername] = useState(""); //hiển thị đã tìm thấy hoặc không tìm thấy trong UI
    ...
    const handleSearch = handleSubmit(async (data) => {
        ...
        try {
            ...
            console.error(`Có lỗi xảy ra khi search user: ${error}`);
            setIsFound(false);
        }
    });
    ...
    const handleSend = handleSubmit( async (data) => {
        ...
        try {
            ...
            console.error(`Có lỗi xảy ra khi gửi request từ form: ${error}`);
        }
    });
