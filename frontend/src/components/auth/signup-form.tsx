...
const signUpSchema = z.object({
  firstname: z.string().min(1, 'Bạn phải nhập tên của mình'),
  lastname: z.string().min(1, 'Bạn phải nhập họ của mình'),
            ...
            <div className="flex flex-col gap-6">
              ...
              {/* header + logo*/}
                <div className="flex flex-col items-center text-center gap-2">
                  ...
                  <h1 className="text-2xl font-bold">Tạo tài khoản Thunder Chat</h1>
              ...
              {/* email */}
                <div className="flex flex-col gap-3">
                  ...
                  <Input type="email" id="email" placeholder="thunder@gmail.com"
                  {...register("email")}
                  />
                    {
                      /* chỗ này hiển thị lỗi */
              ...
              <div className="text-center text-sm">Bạn đã có tài khoản? {" "} <a href="/signin" className="underline underline-offset-4">Đăng nhập</a></div>
            </div>
          </form>
