        ...
        <form onSubmit={onSubmit}>
            <div className="space-y-4">
                <span className="success-message">
                    Đã tìm thấy <span className="font-semibold">@{searchedUsername}</span> rồi nha!
                </span>

                <div className="space-y-2">
                    <Label htmlFor="mesage" className="text-sm font-semibold">
                        Giới thiệu
                    </Label>
                    <Textarea id="message" rows={3} placeholder="Chào bạn, hãy kết bạn nhé!" className="glass border-border/50 focus:border-primary/50 transition-smooth resize-none" {...register("message")}/>
                </div>
                <DialogFooter>
