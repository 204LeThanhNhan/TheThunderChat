    ...
    return (
        <form onSubmit={onSubmit} className="space-y-4">
            <div className="space-y-2">
                ...
                <Input id="username" placeholder="Nhập username để tìm kiếm ..." className="glass border-border/50 focus:border-primary/50 transition-smooth"
                {...register("username", {required: "Vui lòng không bỏ trống username"})}>
                </Input>
                {errors.username && (
